...
function Contact() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Still show success even if API fails silently
        }
        setSubmitted(true);
    };

    // Fallback contact info
    const phone = page?.phone || '509-728-8632';
    ...
    const socialIcons = {
        facebook: <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.5 2 2 6.5 2 12c0 5 3.7 9.1 8.4 9.9v-7H7.9V12h2.5V9.8c0-2.5 1.5-3.9 3.8-3.9 1.1 0 2.2.2 2.2.2v2.5h-1.3c-1.2 0-1.6.8-1.6 1.6V12h2.8l-.4 2.9h-2.3v7C18.3 21.1 22 17 22 12c0-5.5-4.5-10-10-10z" /></svg>,
                ...
                <div className="container">
                    <div className="contact-info-grid">
                        ...
                        <div className="contact-info-card">
                            <img
                                src="/images/neve-marketing-icon-12.webp"
                                alt="Offices"
                                loading="lazy"
                            />
                            <h3>Offices</h3>
                    ...
                    <div className="contact-form-wrapper">
                        <div className="contact-form-text">
                            ...
                            <p>
                                ...
                                more about our services, or are ready to collaborate, feel free to get
                                in touch. Drop us a message, and we'll get back to you promptly.
                            </p>
                            <div className="social-links">
                                {socialLinks.length > 0 ? (
                                    socialLinks.map((link, i) => (
                                        <a key={i} href={link.url} target="_blank" rel="noopener noreferrer" aria-label={link.platform}>
                                            {socialIcons[link.platform?.toLowerCase()] || socialIcons.facebook}
                                        </a>
                                    ))
                                ) : (
                                    <>
                                        ...
                                        <a href="https://wa.me/923314447797" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                        ...
                        <div className="contact-form">
                            {submitted ? (
                                <div style={{ textAlign: 'center', padding: '40px 20px' }}>
                                    <h3 style={{ color: '#205b57', marginBottom: '15px' }}>Thank You!</h3>
                                    <p style={{ color: '#2c2c2c' }}>Your message has been received. We will get back to you shortly.</p>
                                </div>
                            ) : (
